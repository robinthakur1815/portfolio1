        ...
        <div>
            ...
            <div className="ContactPage">
                ...
                <div className="contact-sect">
                    <ContactItem icon={phone} text1={'+91 8076911984'} text2={'+91 7053631758'} title={'Phone'}/>
                    <ContactItem icon={email} text1={'starbin@gmail.com'} text2={'thakurrobin344@gmail.com'} title={'Email'}/>
                    <ContactItem icon={location} text1={'Ghazaibad '} text2={'up'} title={'Address'}/>
                </div>
            </div>
        </div>
    )
